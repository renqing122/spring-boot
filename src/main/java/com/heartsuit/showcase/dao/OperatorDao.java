...
public class OperatorDao {
    ...
    public void insert(Operator operator){
        ...
        document.put("password", StringUtil.convertNullToEmpty(operator.getIsActivation()));
        ...
        document.put("isActivation", StringUtil.convertNullToEmpty(operator.getIsActivation()));
